...
def draw_scenes(points, gt_boxes=None, ref_boxes=None, ref_scores=None, ref_labels=None, ptbg_color=(0,0,0), ptfg_color=(1,1,1), draw_grid=False):
    ...
    fig = visualize_pts(points, bgcolor=ptbg_color, fgcolor=ptfg_color)
    if draw_grid:
